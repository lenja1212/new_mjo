...
#TODO Возможно стоит взять не среднего участника, а несмещенного, которого надо объединить, так разброс будет больше. ensmean использовать именно как климатологию