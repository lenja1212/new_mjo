...
fntmp_list=""
dir_temp="./temp/"
ensmean_year="./erfclim.all-ensmean-olr.nc"
month_30=("4" "6" "9" "11")
...
for f in `ls *.ensmean-*`; do
	generate_tmp_nc_names tmp_d tmp1 tmp2 tmp_ax1 tmp_merge_out
	echo $f
...
# IF the first day is empty 
	cdo delete,timestep=1  $f  $tmp_d 
#
	cdo -settaxis,1991-01-02,$start_hour,1day $tmp_d $tmp1 
